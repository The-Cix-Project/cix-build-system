...
closed. The active issue queue is the authority for remaining work; this status
file prevents old acceptance language from being mistaken for a claim that
standalone CBS owns the whole platform.

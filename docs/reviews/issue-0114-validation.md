...
workspace, fetches and extracts declared sources through the verified fetch
...
standalone pipeline; cixd is not required because the CLI supplies libcurl for
HTTP/HTTPS source transport.

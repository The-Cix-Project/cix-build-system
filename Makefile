...
test: $(TARGET) upstream-test recipe-test
	...
	$(CC) $(CPPFLAGS) $(CFLAGS) tests/identity-test.c \
		src/ast.o src/archive.o src/diag.o src/exec.o src/fs.o src/observe.o src/source.o src/identity.o src/lexer.o src/parser.o \
		src/validate.o -larchive -o tests/identity-test
	...
	$(CC) $(CPPFLAGS) $(CFLAGS) tests/dependency-test.c \
		src/ast.o src/archive.o src/dependency.o src/diag.o src/exec.o src/fs.o src/observe.o src/source.o src/lexer.o src/parser.o \
		src/validate.o -larchive -o tests/dependency-test

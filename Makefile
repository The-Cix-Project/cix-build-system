...
test: $(TARGET) upstream-test recipe-test
	...
	$(CC) $(CPPFLAGS) $(CFLAGS) tests/exec-test.c \
		src/ast.o src/diag.o src/exec.o src/fs.o src/observe.o src/lexer.o src/parser.o src/validate.o \
		-o tests/exec-test
	./tests/exec-test tests/fixtures/execution/argv.cbs
	rm -f tests/exec-test
	$(CC) $(CPPFLAGS) $(CFLAGS) tests/fs-test.c \
		src/ast.o src/archive.o src/diag.o src/exec.o src/fs.o src/observe.o src/lexer.o src/parser.o \
	...
	$(CC) $(CPPFLAGS) $(CFLAGS) tests/identity-test.c \
		src/ast.o src/diag.o src/exec.o src/fs.o src/observe.o src/identity.o src/lexer.o src/parser.o \
	...
	$(CC) $(CPPFLAGS) $(CFLAGS) tests/source-test.c \
		src/ast.o src/archive.o src/diag.o src/exec.o src/fs.o src/observe.o src/lexer.o src/parser.o src/source.o \
	...
	$(CC) $(CPPFLAGS) $(CFLAGS) tests/extract-test.c \
		src/ast.o src/archive.o src/diag.o src/exec.o src/fs.o src/observe.o src/lexer.o \
	...
	$(CC) $(CPPFLAGS) $(CFLAGS) tests/jobs-test.c src/ast.o src/diag.o src/exec.o \
		src/archive.o src/fs.o src/observe.o src/lexer.o src/parser.o src/runtime.o src/validate.o \
		-larchive -o tests/jobs-test
	./tests/jobs-test
	rm -f tests/jobs-test
	$(CC) $(CPPFLAGS) $(CFLAGS) tests/stage-test.c src/runtime.o src/archive.o src/ast.o src/diag.o src/exec.o src/fs.o src/observe.o src/lexer.o src/parser.o src/validate.o -larchive -o tests/stage-test
	./tests/stage-test
	rm -f tests/stage-test
	$(CC) $(CPPFLAGS) $(CFLAGS) tests/manifest-test.c src/manifest.o src/source.o src/archive.o \
		src/ast.o src/diag.o src/exec.o src/fs.o src/observe.o src/lexer.o src/parser.o src/validate.o -larchive -o tests/manifest-test
	./tests/manifest-test
	...
	$(CC) $(CPPFLAGS) $(CFLAGS) tests/package-test.c src/package.o src/prune.o src/cixpkg.o src/source.o src/manifest.o src/archive.o \
		src/ast.o src/diag.o src/exec.o src/fs.o src/observe.o src/lexer.o src/parser.o src/validate.o src/plan.o src/workspace.o src/identity.o src/runtime.o \
	...
	$(CC) $(CPPFLAGS) $(CFLAGS) tests/dependency-test.c \
		src/ast.o src/dependency.o src/diag.o src/exec.o src/fs.o src/observe.o src/lexer.o src/parser.o \
	...
	$(CC) $(CPPFLAGS) $(CFLAGS) tests/policy-test.c src/package.o src/prune.o src/cixpkg.o src/source.o src/manifest.o \
		src/archive.o src/ast.o src/diag.o src/exec.o src/fs.o src/observe.o src/lexer.o src/parser.o src/validate.o \
